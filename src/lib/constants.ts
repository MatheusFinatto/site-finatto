...
export const WPP_MSG_FINATTO =
  "Olá, Finatto! Gostaria de informações sobre imóveis.";
export const WPP_MSG_FLAVIA =
  "Olá, Flávia! Gostaria de informações sobre imóveis.";
