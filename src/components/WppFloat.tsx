...
export default function WppFloat() {
  ...
  useEffect(() => {
    ...
    function onClickOut(e: MouseEvent) {
      const el = document.getElementById('wpp-float')
    ...
    >
      ...
      {open && (
        <div
          ...
          style={{ bottom: 64, right: 0, padding: 12, minWidth: 220, boxShadow: '0 8px 32px rgba(0,0,0,0.15)' }}
        >
          <p className="text-muted-fg uppercase" style={{ fontSize: 10, letterSpacing: 2, marginBottom: 4 }}>
            Falar com
          </p>
          <a
            ...
            style={{ background: 'var(--wpp-green)', color: '#fff', padding: '11px 16px', fontSize: 13 }}
          >
          ...
          <a
            ...
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 font-medium hover:opacity-90 transition-opacity"
            style={{ color: 'var(--wpp-green)', padding: '11px 16px', fontSize: 13, border: '1px solid var(--wpp-green)' }}
          >
      ...
      <button
        ...
        style={{ width: 56, height: 56, background: 'var(--wpp-green)', color: '#fff', border: 'none', cursor: 'pointer' }}
      >
        {open ? (
