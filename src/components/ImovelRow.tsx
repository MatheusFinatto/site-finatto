...
export default function ImovelRow({ imovel }: Props) {
  ...
  const waLink = whatsappLink(WHATSAPP_FINATTO, wppMsgImovel(imovel.titulo, formatPreco(imovel.preco)))
  ...
  return (
    <div className="imovel-row group">
      ...
      <div className="imovel-row-area text-right" style={{ minWidth: 110 }}>
        ...
        <span className="text-muted-fg uppercase" style={{ fontSize: 11, letterSpacing: 1 }}>área total</span>
      </div>
