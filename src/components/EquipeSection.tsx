    ...
    <section id="sobre" className="border-t border-border">
      ...
      <div className="md:hidden">
        ...
        <div className="relative w-full" style={{ height: 220 }}>
          ...
          >
            <p
              ...
              style={{ fontSize: 10, letterSpacing: 3, marginBottom: 6 }}
            >
              Equipe
            </p>
            <h2
        ...
        <div
          ...
          style={{ gap: 1, background: "var(--border)", margin: "24px 0 0" }}
        >
          {team.map((p) => (
            <a
              key={p.nome}
            ...
            >
              <div className="flex flex-col gap-1">
                ...
                <p
                  className="text-fg"
                  style={{ fontFamily: "var(--font-dm-serif)", fontSize: 20 }}
                >
                  {p.nome}
                </p>
                <p
            ...
            {team.map((p) => (
              ...
              >
                ...
                <span
                  ...
                  style={{ color: "var(--wpp-green)", fontSize: 11 }}
                >
